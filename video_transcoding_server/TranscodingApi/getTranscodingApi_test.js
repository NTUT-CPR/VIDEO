...
app.get('/myapi', function (req, res) {
	...
	callfile.execFile('/home/lab1323/桌面/TranscodingApi/decodeFile.sh',['-V', Filename, '-Q', QP],null,function (err, stdout, stderr) {
		if(stderr.length>1)
			console.log("err");
		else
			console.log("succeed");
...
function getData(){
	...
	finishFile = '/home/lab1323/桌面/TranscodingApi/'+Nowtask;
	finishFile = finishFile+'_'+NowtaskQP+'_finish.txt';
	if(Filename_Queue_arr.length!=0 && fsExistsSync(finishFile)&&tag==1){
